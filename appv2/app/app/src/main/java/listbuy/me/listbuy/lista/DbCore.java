...
public class DbCore extends SQLiteOpenHelper {
    ...
    private static final int DB_VERSION = 7; // toda vez que for alterar algo na tabela, como drop ou inserir sempre mudar a versão senão não funciona
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table consumidor (id_consumidor integer,nome_consumidor text,email_cosumidor text, senha text,id_tipo_acesso text)");
    }
